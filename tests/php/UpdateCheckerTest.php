...
class UpdateCheckerTest extends TestCase {
    ...
    private function get_plugin_source(): string {
        return file_get_contents( dirname( __DIR__, 2 ) . '/pikari-gutenberg-modals.php' );
    }
    ...
    public function test_asset_filter_matches_the_release_workflow_zip_name(): void {
        ...
        $this->assertMatchesRegularExpression(
            $asset_filter_regex,
            'pikari-gutenberg-modals-v1.2.3.zip',
            'The asset filter must match the pikari-gutenberg-modals-vX.Y.Z.zip name that release.yml builds.'
        );

        // ...and must NOT match the checksums file uploaded alongside it.
        $this->assertDoesNotMatchRegularExpression(
            $asset_filter_regex,
            'pikari-gutenberg-modals-v1.2.3-checksums.txt',
