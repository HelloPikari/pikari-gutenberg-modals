...
export const blockFixtures = {
	paragraph: {
		name: 'core/paragraph',
		attributes: {
			content: 'This is a test paragraph with a <span class="modal-link-trigger" data-modal-content-type="post" data-modal-content-id="123">modal link</span>.',
		},
	},
	...
	heading: {
		name: 'core/heading',
		attributes: {
			content: 'Heading with <span class="modal-link-trigger" data-modal-content-type="page" data-modal-content-id="456">modal</span>',
			level: 2,
		},
	},
...
export const modalContentFixtures = {
	...
	page: {
		...
		content: {
			rendered: '<div class="wp-block-group"><p>Test page content with blocks.</p></div>',
		},
	...
	withStyles: {
		...
		content: {
			rendered: '<div class="has-background has-primary-background-color">Styled content</div>',
		},
		_embedded: {
			styles: [
